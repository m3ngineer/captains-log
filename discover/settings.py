...
if USE_S3_STATIC:
    ## Configure Django-storages to serve static files from AWS S3
    # Django-storages uses S3 as main Django storage backend
    # Boto3 used to interact with AWS API
    FULL_DOMAIN = 'https://s3.amazonaws.com/journal-static'
